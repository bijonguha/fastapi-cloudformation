...
def get_api_key():
    ...
    if ENVIRONMENT == 'LOCAL':
        ...
        if not ssm_client:
            ...
            raise HTTPException(status_code=500, detail="AWS SSM client not configured")
        ...
        raise HTTPException(status_code=500, detail=f"Unsupported environment: {ENVIRONMENT}")
...
@app.post("/hello")
async def hello(request: HelloRequest, request_obj: Request, api_key: str = Header(None, alias="X-API-Key")):
